...
const ItemImage = styled.img`
    ...
    color-stop(1.00,  rgba(0,0,0,0.05))
    );
`
...
useEffect(() => {
  ...
  const handleMouseLeave = () => {
    setAutoScroll(true); // Resume auto-scroll when the mouse leaves the element
    //setInterval(MoveToNextItem, intervalTime);
    console.log("Start");
  };
    ...
    return (
        <Slider ref={slide_ref} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            <Header>
