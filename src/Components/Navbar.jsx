...
const Navbar = ({ currentPage }) => {
  ...
  return (
    <Nav>
      ...
      <List>
        <StyledLi $active={location.pathname === "/" ? "active" : ""}>
          <Link to="/">Home</Link>
        </StyledLi>
        <StyledLi $active={location.pathname === "/menu" ? "active" : ""}>
          <Link to="/menu">Our Menu</Link>
        </StyledLi>
        <StyledLi $active={location.pathname === "/booking" ? "active" : ""}>
          <Link to="/booking">Reserve A Table</Link>
        </StyledLi>
        <StyledLi $active={location.pathname === "/order" ? "active" : ""}>
